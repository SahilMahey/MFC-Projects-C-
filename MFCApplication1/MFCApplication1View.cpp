...
BEGIN_MESSAGE_MAP(CMFCApplication1View, CView)
	...
	ON_COMMAND(ID_DRAW_CIRCLE, &CMFCApplication1View::On19)
	ON_COMMAND(ID_DRAW_RECTANGLE, &CMFCApplication1View::On20)
	ON_UPDATE_COMMAND_UI(ID_DRAW_CIRCLE, &CMFCApplication1View::OnUpdate19)
	ON_UPDATE_COMMAND_UI(ID_DRAW_RECTANGLE, &CMFCApplication1View::OnUpdate20)
END_MESSAGE_MAP()
...
void CMFCApplication1View::On19()
{
...
void CMFCApplication1View::On20()
{
	// TODO: Add your command handler code here
...
void CMFCApplication1View::OnUpdate19(CCmdUI* pCmdUI)
{
	// TODO: Add your command update UI handler code here
	pCmdUI->Enable(!draw_something);
}

void CMFCApplication1View::OnUpdate20(CCmdUI* pCmdUI)
{
	// TODO: Add your command update UI handler code here
	pCmdUI->Enable(draw_something);
}
